...
import numpy as np
#import chess
from chess.pythonchess.chess import svg
#import chess.svg
...
class MCTS():
    ...
    def search(self, canonicalBoard):
        ...
        boardsvg = chess.svg.board(board = canonicalBoard)
        filetowriteto = open('./boardimg3/move'+str(self.args.counter)+'.jpg', "w")
        ...
        #exit()
        # print("default_random_act: ", best_act)
        cur_best = -float('inf')
        #best_act = -1
        ...
        # print('MCTS.py==>search ', 'best_act: ', a)
